...
/**
 * Build inline code for "NegatedObject" instruction
 *
 * @param {Node|{ isStraightForward: boolean, index: int, nextIndex: int }} node
 * @returns {string}
 */
function buildNegatedObjectInstructionCode (node) {
  ...
  const condition = options.length === 1
    ? `ok = ${buildOptionCode('objects[index]', options[0])}`
...
module.exports = buildNegatedObjectInstructionCode
