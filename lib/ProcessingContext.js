 ...
 *
 * @returns {null|{ expectations: Array<{ head: null|string, [oneOf]: string[], [notOneOf]: string[], [any]: boolean }> }}
 */
ProcessingContext.prototype.getFailedResult = function getFailedResult () {
  return this.expectations.length ? {
    expectations: this.expectations.map(buildExpectation)
  } : null
}
 ...
 *
 * @returns {{index: number, length: number, groups: object}}
 */
